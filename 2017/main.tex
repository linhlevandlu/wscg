...
\copyrightspace
  ...
  and right mandibles (see Fig. \ref{figparts}) and a set of landmarks has been manually located:
  ...
  biological studies. It is a large field in image processing and
  appears in  most topics of computer vision such as face detection,
  human orthodontic, morphometric analysis \ldots \cite{li09}\cite{favaedi2010cephalometric}\cite{bec03}.
...
not consider all points of the imag. We only take into account the area around each landmark on the model.
...
After experiments, we have kept 36X36 pixels as the size of \textit{$P_s$}.
...
For example, we could investigate the isomorphic registration methods to be more robust to the inter-species variations of mandible shapes.
